        ...
        >
          <div className="grid grid-cols-3 col-span-3 col-start-1 gap-4">
            ...
            <div className="col-span-2 col-start-2 text-start">
              <div className="w-3/4 h-5 mb-2 rounded bg-neutralViolet-700"></div>
              <div className="w-1/2 h-4 mb-1 rounded bg-neutralViolet-700"></div>
              <div className="w-1/4 h-3 rounded bg-neutralViolet-700"></div>
            </div>
          </div>
